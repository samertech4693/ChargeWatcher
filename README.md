...
## Features
- Plays plug/unplug sounds for your charger
...
## How to Use
1. Download `ChargeWatcher_Setup.exe`
2. Run the installer and follow the wizard
3. The app will appear in your system tray and start monitoring your AC adapter
